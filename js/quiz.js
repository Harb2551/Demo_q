let quizData = [
    {
      question: "Wht is the capital of Italy?",
  ...
  function loadNextQuestion() {
    ...
    if (currentQuestionIndex < quizData.length - 1) {
      ...
      displayQuestion();
      startTimer(); // Call startTimer after loading the question
    } else {
      clearInterval(timer);
  ...
  function displayQuestion() {
    ...
    currentQuestion.options.forEach((option, index) => {
      ...
      optionButton.setAttribute("data-option", option); // Set a data attribute
  ...
  function selectAnswer(answer) {
    ...
    // Update UI to indicate selected answer if needed
  }
